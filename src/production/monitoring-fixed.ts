...
export class MonitoringSystem {
  ...
  startRequest(requestId: string, userId?: string): void {
    ...
    this.writeLog('info', 'Request started', {
      requestId,
      userId,
  ...
  endRequest(
    ...
    this.writeLog('info', 'Request completed', {
      requestId,
      userId,
      success,
      duration,
  ...
  recordAIUsage(
    ...
    this.writeLog('info', 'AI request completed', {
      model,
      tokensUsed,
      cost,
      success,
  ...
  createAlert(
    ...
    this.writeLog('warn', `Alert created: ${message}`, {
      alertId: alert.id,
      type,
      severity,
      metadata,
  ...
  resolveAlert(alertId: string): boolean {
    ...
    if (alert && !alert.resolved) {
      ...
      this.writeLog('info', `Alert resolved: ${alert.message}`, {
        alertId,
