...
class ManagedConnection {
  constructor(endpoint, type, config) {
    this.config = config;
    this.socket = null;
   ...
   */
  sendWebSocketRequest(requestId, data, timeout) {
    return new Promise((resolve, reject) => {
   ...
   * Send HTTP request
   */
  async sendHttpRequest(data, timeout) {
   ...
   */
  calculateQualityScore(rttMs, jitterMs) {
...
export class ConnectionManager {
  constructor(config = {}) {
    ...
    this.endpointConnections = new Map();
   ...
   */
  async getConnection(endpoint, type) {
   ...
   */
  getLeastRecentlyUsedConnection() {
    let lru = null;
