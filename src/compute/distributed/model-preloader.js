...
export class ModelPreloader {
   ...
   * Record model usage
   */
  recordUsage(modelId, contextModelIds = []) {
    // Update access
    const cached = this.cache.get(modelId);
    if (cached) {
      cached.lastAccessedAt = Date.now();
   ...
   */
  triggerPredictivePrefetch(currentModelId) {
...
//# sourceMappingURL=model-preloader.js.map
