...
------------ | ------------- | ------------- | -------------
**PromptTokens** | Pointer to **int32** | Number of tokens in the prompt | [optional] 
**CompletionTokens** | Pointer to **int32** | Number of tokens in the completion | [optional] 
**TotalTokens** | Pointer to **int32** | Total tokens used (prompt + completion) | [optional] 
